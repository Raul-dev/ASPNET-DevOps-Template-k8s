...
namespace ShopManager.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnurl = null)
        {
            ...
            var user = new ApplicationUser() { UserName = model.Name, Email = model.Email, Name = model.Name, DateCreated = DateTime.Now };
        ...
        public async Task<IActionResult> EnableAuthenticator()
        {
            ...
            string AuthenticatorUri = string.Format(AuthenticatorUriFormat, _urlEncoder.Encode("ShopManager"), _urlEncoder.Encode(user.Email), token);
