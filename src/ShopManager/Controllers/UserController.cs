    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Edit(ApplicationUser user)
        {
            if (ModelState.IsValid)
            {
                ...
                _db.SaveChanges();
                TempData[DataState.Success] = "User has been edited successfully.";
        ...
        public IActionResult LockUnlock(string userId)
        {
            ...
            if (objFromDb.LockoutEnd != null && objFromDb.LockoutEnd > DateTime.Now)
            {
                ...
                TempData[DataState.Success] = "User unlocked successfully.";
            }
            else
            {
                // User is not locked, and we want to lock the user
                objFromDb.LockoutEnd = DateTime.Now.AddDays(2);
                TempData[DataState.Success] = "User locked successfully.";
            }
        ...
        public IActionResult Delete(string userId)
        {
            ...
            _db.SaveChanges();
            TempData[DataState.Success] = "User deleted successfully.";
            return RedirectToAction(nameof(Index));
        }
        ...
        public async Task<IActionResult> ManageUserClaims(UserClaimsViewModel userClaimsViewModel)
        {
            ...
            if (!result.Succeeded)
            {
                TempData[DataState.Error] = "Error while removing claims";
            ...
            if (!result.Succeeded)
            {
                TempData[DataState.Error] = "Error while adding claims";
                return View(userClaimsViewModel);
            }

            TempData[DataState.Success] = "Claims updated successfully";
            return RedirectToAction(nameof(Index));
        }
    }
}
